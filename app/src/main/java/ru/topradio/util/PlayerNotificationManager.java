 ...
 * </ul>
 *
 * <p>Alternatively, the action icons can be set programatically by using the {@link com.google.android.exoplayer2.ui.PlayerNotificationManager.Builder}.
 *
 ...
 * large icon is obtained from the {@link com.google.android.exoplayer2.ui.PlayerNotificationManager.MediaDescriptionAdapter} passed to {@link
 * com.google.android.exoplayer2.ui.PlayerNotificationManager.Builder#Builder(Context, int, String, com.google.android.exoplayer2.ui.PlayerNotificationManager.MediaDescriptionAdapter)}.
 */
public class PlayerNotificationManager {
    ...
    public interface MediaDescriptionAdapter {
         ...
         * returned. The actual bitmap should be passed to the {@link com.google.android.exoplayer2.ui.PlayerNotificationManager.BitmapCallback} once it has been
         ...
         *
         * @param player The {@link Player} for which a notification is being built.
         * @param callback A {@link com.google.android.exoplayer2.ui.PlayerNotificationManager.BitmapCallback} to provide a {@link Bitmap} asynchronously.
         * @return The large icon for the current media item, or null if the icon will be returned
         *     through the {@link com.google.android.exoplayer2.ui.PlayerNotificationManager.BitmapCallback} or if no icon should be displayed.
         */
        @Nullable
    ...
    public interface CustomActionReceiver {
         ...
         *
         * <p>If multiple {@link com.google.android.exoplayer2.ui.PlayerNotificationManager} instances are in use at the same time, the
         * {@code instanceId} must be set as an intent extra with key {@link
         * com.google.android.exoplayer2.ui.PlayerNotificationManager#EXTRA_INSTANCE_ID} to avoid sending the action to every custom
         ...
         * @param instanceId The instance id of the {@link com.google.android.exoplayer2.ui.PlayerNotificationManager}.
    ...
    /** A builder for {@link com.google.android.exoplayer2.ui.PlayerNotificationManager} instances. */
    public static class Builder {
        ...
        @Nullable private com.google.android.exoplayer2.ui.PlayerNotificationManager.NotificationListener notificationListener;
        @Nullable private com.google.android.exoplayer2.ui.PlayerNotificationManager.CustomActionReceiver customActionReceiver;
        ...
        public Builder(Context context, int notificationId, String channelId) {
            ...
            mediaDescriptionAdapter = new ru.topradio.util.DefaultMediaDescriptionAdapter(/* pendingIntent= */ null);
        ...
        /**
         * The {@link com.google.android.exoplayer2.ui.PlayerNotificationManager.NotificationListener} to be used.
         *
         * <p>The default is {@code null}.
         *
         * @return This builder.
         */
        public PlayerNotificationManager.Builder setNotificationListener(com.google.android.exoplayer2.ui.PlayerNotificationManager.NotificationListener notificationListener) {
            this.notificationListener = notificationListener;
            return this;
        }

        /**
         * The {@link com.google.android.exoplayer2.ui.PlayerNotificationManager.CustomActionReceiver} to be used.
         *
         * <p>The default is {@code null}.
         *
         * @return This builder.
         */
        public PlayerNotificationManager.Builder setCustomActionReceiver(com.google.android.exoplayer2.ui.PlayerNotificationManager.CustomActionReceiver customActionReceiver) {
        ...
        /**
         * The {@link com.google.android.exoplayer2.ui.PlayerNotificationManager.MediaDescriptionAdapter} to be queried for the notification contents.
         *
        ...
        /** Builds the {@link com.google.android.exoplayer2.ui.PlayerNotificationManager}. */
     ...
     * and calls {@link com.google.android.exoplayer2.ui.PlayerNotificationManager.NotificationListener#onNotificationCancelled(int, boolean)}.
     */
    ...
    @Nullable private final com.google.android.exoplayer2.ui.PlayerNotificationManager.NotificationListener notificationListener;
    @Nullable private final com.google.android.exoplayer2.ui.PlayerNotificationManager.CustomActionReceiver customActionReceiver;
    ...
    private PlayerNotificationManager(
            ...
            @Nullable com.google.android.exoplayer2.ui.PlayerNotificationManager.NotificationListener notificationListener,
            @Nullable com.google.android.exoplayer2.ui.PlayerNotificationManager.CustomActionReceiver customActionReceiver,
        ...
        playerListener = new PlayerNotificationManager.PlayerListener();
        notificationBroadcastReceiver = new PlayerNotificationManager.NotificationBroadcastReceiver();
        ...
        if (largeIcon == null) {
            largeIcon =
                    mediaDescriptionAdapter.getCurrentLargeIcon(
                            player, new PlayerNotificationManager.BitmapCallback(++currentNotificationTag));
        }
     ...
     * map returned by {@link com.google.android.exoplayer2.ui.PlayerNotificationManager.CustomActionReceiver#createCustomActions(Context, int)}. Otherwise the
    ...
    private class NotificationBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (ACTION_PLAY.equals(action)) {
                ...
                controlDispatcher.dispatchStop(player, /* playWhenReady= */ false);
